...
def recognize():
	...
	cv2.putText(blackboard, "S    : Enable hand tracking", (10, 20), cv2.FONT_HERSHEY_TRIPLEX, 0.75, (0, 255, 255))
	cv2.putText(blackboard, "IJKL : Adjust box", (10, 40), cv2.FONT_HERSHEY_TRIPLEX, 0.75, (0, 255, 255))
